...
2. Read the skill at `.codex/skills/[name]/SKILL.md` when testing the imported Codex skill; use `.claude/skills/[name]/SKILL.md` only as historical source material.
