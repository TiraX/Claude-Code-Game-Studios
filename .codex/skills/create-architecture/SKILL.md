...
**Step 2 — Spawn `lead-programmer` via the available multi-agent tool using gate LP-FEASIBILITY (`.claude/docs/director-gates.md`):**
...
Use `ask the user` — "Technical Director and Lead Programmer have reviewed the architecture. How would you like to proceed?"
